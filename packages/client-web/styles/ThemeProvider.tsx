...
import { makeCreateSsrMuiTheme } from '@my-project/client-web/styles/utils/createSsrMuiTheme';
import createDefaultTheme from '@my-project/client-web/styles/themes/default';
